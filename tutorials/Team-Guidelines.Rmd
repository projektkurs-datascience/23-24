...
To Do:
  - Streichen eines Gruppenmitglieds, oder Team auflösen und die Person muss das Ganze allein machen?
  - Erwartungen an die Gruppenarbeit dokumentieren lassen -> Auch eigene Notenerwartung / Arbeitsaufwand
  - Beispiel Team Contract erstellen den die Studis nutzen können
  - Beispiel Team Contract in die Guidelines einfügen
  - Umgang mit AI in den Formalia aufnehmen
  - 
```
