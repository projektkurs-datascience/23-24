...
- Die Gruppe bekommt **eine Note** für **alle Gruppenmitglieder**
  ...
  - Ein **Teamvertrag** soll wieder **verpflichtend** erstellt werden
...
## Projekt 6: Frauen in Tech-Firmen
...
.alert[Warum gibt es so wenige Frauen in Tech-Firmen und wie kann dem entgegengewirkt werden?]

Zur Beantwortung dieser Frage werten Sie einen **bereitgestellten Datensatz** aus einem Feldexperiement in Peru aus. 
]
.pull-right[
<br><br>
```{r, echo=FALSE, out.width="80%"}
zensur <- "figs/Big_Tech_companies.jpg"
