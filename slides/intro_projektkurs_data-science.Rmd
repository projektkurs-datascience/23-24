...
## Projekt 3: Wettbewerbsanalyse für eine Krankenvollversicherung
...
.alert[Wie könnten Sie sich als (neue) private Krankenversicherung im Markt positionieren? Welche Faktoren könnten in der Wettbewerbsanalyse wichtig sein?]

Zur Beantwortung dieser Fragen analysieren Sie die Wettbewerbssituation für eine private Krankenvollversicherung in Deutschland.
]
.pull-right[
<br><br>
```{r, echo = FALSE, out.width="100%"}
preise <- "figs/PKV_Preise.png"
include_graphics(preise)
```

<font size="1">Quelle: Bundestag_Drucksache_19746</font> 
]
